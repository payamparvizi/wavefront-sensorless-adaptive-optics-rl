...
def get_args():
    ...
    parser.add_argument("--loss_lambda", type=float, default=1e-3)             # weight lambda
    ...
    parser.add_argument("--c_homog", type=rounded_float, default=1.0)
    ...
    parser.add_argument('--atm_vel', type=float, default=500)
