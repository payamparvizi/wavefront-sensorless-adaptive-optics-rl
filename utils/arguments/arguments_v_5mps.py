...
def get_args():
    ...
    parser.add_argument('--stack_num', type=int, default=9)
    ...
    parser.add_argument("--k_init", type=float, default=3.0)                   # Initial Lipschitz constant K_init
    parser.add_argument("--loss_lambda", type=float, default=1e-5)             # weight lambda
    ...
    parser.add_argument("--k_sizes", type=int, default=256)
    ...
    # APS patameters
    parser.add_argument("--lambda_P", type=rounded_float, default=0.05)
    parser.add_argument("--c_homog", type=rounded_float, default=7.0)
    ...
    parser.add_argument('--atm_vel', type=float, default=5)
